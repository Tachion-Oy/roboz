...
\begin{tikzpicture}[font=\sffamily]
  ...
  \node[passive] (escalate) at (6,-8.75) {
    ...
    {\scriptsize tell user they are pushing it; ask different LLM for their opinion}
  };
  ...
  \node[stop] (stop) at (8.5,-18.25) {
    ...
    {\large\bfseries Too much spiciness}\\[-0.2mm]
    {\scriptsize Two even numbers?! Hot dang!}
  };
