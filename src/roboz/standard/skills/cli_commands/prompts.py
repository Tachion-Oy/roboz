"""Prompts for the constrained CLI commands skill."""

from typing import Final

from roboz.standard.identifiers import RUN_FILE_COMMAND_TOOL_NAME

DESCRIPTION: Final[str] = (
    f"How to use Agent's constrained Unix file CLI via `{RUN_FILE_COMMAND_TOOL_NAME}`: input shape, "
...
{"chain": "pipe", "file_commands": [{"command": "rg", "argv": ["-n", "needle", "rbz_solutions/game_player/game_player_data/conversations/"]}]}
