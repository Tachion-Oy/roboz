"""Reference output for the conversation snapshot tool."""

SNAPSHOT_CONVERSATION_EXAMPLE = """## Goals and intent
...
- Summarization wired through `summarize_conversation_segment` in `src/roboz/standard/tools/conversation_summarization/summarize.py`; segment ended with unit tests passing.
...
- Key files: `src/roboz/standard/agents/librarian/agent.py`, `src/roboz/standard/tools/conversation_summarization/snapshot/tool.py`, `src/roboz/standard/tools/utils.py`.
