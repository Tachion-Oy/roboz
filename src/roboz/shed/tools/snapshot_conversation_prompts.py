...
from roboz.shed.tools.snapshot_conversation_example import SNAPSHOT_CONVERSATION_EXAMPLE
...
SNAPSHOT_CONVERSATION_INSTRUCTIONS: Final[str] = f"""Record one snapshot of the new conversation segment.
