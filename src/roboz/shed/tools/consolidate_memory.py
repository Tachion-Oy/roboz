...
from roboz.shed.identifiers import CONSOLIDATE_MEMORY_TOOL_NAME
from roboz.shed.tools._snapshot_metadata import parse_snapshot_document
from roboz.shed.tools.compactification import (
    summarize_conversation_segment,
)
from roboz.shed.tools.consolidate_memory_prompts import (
...
from roboz.shed.tools.contexts import ConsolidateMemoryContext
