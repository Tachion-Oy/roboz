...
from roboz.shed.tools.consolidate_memory_example import CONSOLIDATE_MEMORY_EXAMPLE
from roboz.shed.tools.consolidate_memory_prompts import CONSOLIDATE_MEMORY_INSTRUCTIONS
