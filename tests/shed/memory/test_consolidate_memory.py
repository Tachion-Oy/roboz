...
import pytest
from roboz.shed.tools import ConsolidateMemoryContext
from roboz.shed.tools import consolidate_memory
...
consolidate_module = importlib.import_module("roboz.shed.tools.consolidate_memory")
