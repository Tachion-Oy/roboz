...
import pytest
from roboz.shed.tools.compactification import summarize as summarize_module
from roboz.shed.tools.compactification import summarize_conversation_segment
